...
class BHyveZoneValve(BHyveCoordinatorEntity, ValveEntity):
    ...
    def is_closed(self) -> bool:
        ...
        if watering_status and isinstance(watering_status, dict):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        if watering_status and isinstance(watering_status, dict) and str(watering_status.get("current_station")) == str(
            self._zone_id
        ):
